...
describe('E2E tests', function () {
  ...
  // Test proper
  describe.skip('Authentication [ 20 Points ]', () => {
  ...
  describe.skip('Navigation bar [ 10 Points ]', () => {
  ...
  describe.skip('Home Page [ 5 Points ]', () => {
  ...
  describe.skip('Dashboard Page [ 15 Points ]', () => {
